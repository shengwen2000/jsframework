...
namespace angular001.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from angular001", message);
